...
const inputTitle = document.querySelector(".popup__text_type_title");
const inputLinkImg = document.querySelector(".popup__text_type_link");
...
// card
buttonAddProfile.addEventListener("click", openCard);
